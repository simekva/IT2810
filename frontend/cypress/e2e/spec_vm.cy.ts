...
describe("Opens home page", () => {
  it("should load homepage", () => {
    ...
    // Assert correct URl
    cy.url().should("eq", "http://it2810-53.idi.ntnu.no/project2/");
  });
});
...
describe("Navbar test", () => {
  ...
  it("should link to ./myPage", () => {
    ...
    cy.url().should("eq", "http://it2810-53.idi.ntnu.no/project2/myPage");
  });
...
describe("Home page test", () => {
  ...
  it("navigates to genre", () => {
    ...
    cy.url().should(
      "eq",
      "http://it2810-53.idi.ntnu.no/project2/filter/Romance"
    );
  });
  ...
  it("navigates to genre", () => {
    ...
    cy.url().should(
      "eq",
      "http://it2810-53.idi.ntnu.no/project2/filter/Action"
    );
  });
  ...
  it("clicks on movie and navigates to its page", () => {
    ...
    cy.url().should(
      "eq",
      "http://it2810-53.idi.ntnu.no/project2/movie/6558d7c9998dcef6f26c4334"
    );
  });
});
...
describe("Genre page test", () => {
  ...
  it("changes genre to selected genre", () => {
    ...
    cy.url().should(
      "eq",
      "http://it2810-53.idi.ntnu.no/project2/filter/Musical"
    );
  });
...
describe("Movie page test", () => {
  beforeEach(() => {
    ...
    cy.visit("/");
    cy.get("#searchButton").click();
    cy.get("#searchField").type("Forrest Gump");
    cy.get("#searchResult_6558d7c9998dcef6f26c433a").click();
  });
